import{E as v,x as $,b as a}from"./iframe-Dhkz58ai.js";import"./preload-helper-PPVm8Dsz.js";const l=t=>t??v;function h(t,e,s){return t?e(t):s?.(t)}const d=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`add-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,p=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
  <svg
    slot=${l(t)}
...
`,f=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`cancel-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,u=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`check-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,w=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`clear-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,x=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`edit-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,z=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
  <svg
    slot=${l(t)}
    class=${`error-icon ${s??""}`}
    viewBox="0 0 24 24"
...
`,C=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
...
`,b=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`eye-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,L=({part:t,slot:e,title:s,className:o,width:i="24",height:c="24",styles:n}={})=>$`
	<svg
		slot=${l(e)}
		part=${l(t)}
...
`,V=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
    slot=${l(t)}
    class=${`filter-icon ${s??""}`}
    width=${o}
    height=${i}
  ...
  >
    ...
    <path
      ...
      stroke-linejoin="round"
    />
  </svg> `,k=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
...
`,I=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
	...
	>
		...
		<path
			...
			fill="#EA4335"
		/>
	</svg>`,H=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
...
`,S=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`right-chevron-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,_=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
...
`,D=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`undo-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,E=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`upload-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,T=Object.freeze(Object.defineProperty({__proto__:null,addIcon:d,announcementIcon:p,arrowDropdownIcon:M,calendarIcon:g,cancelIcon:f,checkIcon:u,clearIcon:w,deleteIcon:m,editIcon:x,errorIcon:z,expandLessIcon:C,expandMoreIcon:y,eyeIcon:b,fileDownloadIcon:L,filterIcon:V,findInPageIcon:k,fullscreenExitIcon:A,fullscreenIcon:I,googleIcon:B,helpOutlineIcon:H,infoIcon:R,inviteIcon:Y,leftChevronIcon:Z,rightChevronIcon:S,selectAllIcon:j,trendingDownIcon:_,trendingUpIcon:O,undoIcon:D,uploadIcon:E,wandIcon:F,warningIcon:P},Symbol.toStringTag,{value:"Module"})),G={title:"Cosmoz Icons"},r=()=>$`<ul>
        ${Object.entries(T).map(([t,e])=>$`<li>${[t,e()]}</li>`)}
    </ul>`;r.parameters={docs:{description:{story:"A collection of various icons used throughout Cosmoz."}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => {\n  return html`<ul>\n        ${Object.entries(icons).map(([k, value]) => html`<li>${[k, value()]}</li>`)}\n    </ul>`;\n}",...r.parameters?.docs?.source}}};const J=["Icons"];export{r as Icons,J as __namedExportsOrder,G as default};
