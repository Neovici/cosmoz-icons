import{E as v,x as $,b as r}from"./iframe-B4qcZzh7.js";import"./preload-helper-PPVm8Dsz.js";const l=t=>t??v;function a(t,e,s){return t?e(t):s?.(t)}const d=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`add-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,V=({part:t,slot:e,title:s,className:o,width:i="24",height:c="24",styles:n}={})=>$`
	<svg
		slot=${l(e)}
		part=${l(t)}
...
`,b=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
    slot=${l(t)}
    class=${`filter-icon ${s??""}`}
    width=${o}
    height=${i}
...
`,A=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
	...
	</svg>`,H=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
		slot=${l(t)}
		class=${`google-icon ${s??""}`}
		viewBox=${`0 0 ${o} ${i}`}
		preserveAspectRatio="xMidYMid meet"
