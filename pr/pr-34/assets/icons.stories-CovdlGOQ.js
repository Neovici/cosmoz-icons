import{E as v,x as $,b as a}from"./iframe-HaVtQ-Pk.js";import"./preload-helper-PPVm8Dsz.js";const l=t=>t??v;function h(t,e,s){return t?e(t):s?.(t)}const d=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
		class=${`add-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,z=({part:t,slot:e,title:s,className:o,width:i="24",height:c="24",styles:n}={})=>$`
	<svg
		slot=${l(e)}
		part=${l(t)}
...
`,C=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`<svg
		slot=${l(t)}
...
`,k=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>$`
	<svg
		slot=${l(t)}
