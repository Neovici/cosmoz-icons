import{E as d,x as a,b as $}from"./iframe-939WYCZO.js";import"./preload-helper-D9Z9MdNV.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function r(t,e,s){return t?e(t):s?.(t)}const v=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`add-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,p=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`arrow-dropdown-icon ${s??""}`}
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
		width=${o}
...
`,g=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`cancel-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,M=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`check-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,f=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`clear-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,u=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`edit-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,w=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`expand-more-icon ${s??""}`}
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
		width=${o}
...
`,x=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`eye-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,z=({part:t,slot:e,title:s,className:o,width:i="24",height:c="24",styles:n}={})=>a`
	<svg
		slot=${l(e)}
		part=${l(t)}
...
`,C=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,y=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`<svg
		slot=${l(t)}
		class=${`fullscreen-exit-icon ${s??""}`}
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
		width=${o}
	...
	</svg>`,b=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`<svg
		slot=${l(t)}
	...
	</svg>`,A=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`<svg
		slot=${l(t)}
		class=${`google-icon ${s??""}`}
		viewBox=${`0 0 ${o} ${i}`}
		preserveAspectRatio="xMidYMid meet"
	...
	>
		...
		<path
			...
			fill="#EA4335"
		/>
	</svg>`,I=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,B=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`info-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,L=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`invite-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,V=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,R=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`right-chevron-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,Y=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,H=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,k=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`trending-up-icon ${s??""}`}
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
		width=${o}
...
`,Z=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`undo-icon ${s??""}`}
		viewBox="0 0 24 24"
...
`,S=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`upload-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,_=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
		class=${`wand-icon ${s??""}`}
		viewBox="0 0 48 48"
...
`,O=({slot:t,title:e,className:s,width:o="24",height:i="24",styles:c}={})=>a`
	<svg
		slot=${l(t)}
...
`,j=Object.freeze(Object.defineProperty({__proto__:null,addIcon:v,arrowDropdownIcon:p,cancelIcon:g,checkIcon:M,clearIcon:f,editIcon:u,expandLessIcon:m,expandMoreIcon:w,eyeIcon:x,fileDownloadIcon:z,findInPageIcon:C,fullscreenExitIcon:y,fullscreenIcon:b,googleIcon:A,helpOutlineIcon:I,infoIcon:B,inviteIcon:L,leftChevronIcon:V,rightChevronIcon:R,selectAllIcon:Y,trendingDownIcon:H,trendingUpIcon:k,undoIcon:Z,uploadIcon:S,wandIcon:_,warningIcon:O},Symbol.toStringTag,{value:"Module"})),F={title:"Cosmoz Icons"},h=()=>a`<ul>
        ${Object.entries(j).map(([t,e])=>a`<li>${[t,e()]}</li>`)}
    </ul>`;h.parameters={docs:{description:{story:"A collection of various icons used throughout Cosmoz."}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"() => {\n  return html`<ul>\n        ${Object.entries(icons).map(([k, value]) => html`<li>${[k, value()]}</li>`)}\n    </ul>`;\n}",...h.parameters?.docs?.source}}};const P=["Icons"];export{h as Icons,P as __namedExportsOrder,F as default};
